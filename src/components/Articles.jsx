...
import Article1 from "../assets/Family Values - In Company.png";
import Article2 from "../assets/laravel.jpeg";
import Article3 from "../assets/NetBox.png";
...
const FeaturedArticle = ({ title, summary, img, link, time}) => {
    return (
      <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-dark bg-light p-6 relative rounded-br-3xl dark:bg-dark dark:text-light dark:border-light md:p-2">
        <div className="absolute top-0 -right-2 -z-10 w-[101%] h-[102%] rounded-[2rem] bg-dark rounded-br-3xl cursor-pointer" />
      ...
      <Layout className="py-16">
        ...
        <ul className="grid grid-cols-4 gap-10 mb-32 lg:gap-8 md:grid-cols-1 md:gap-y-14">
          <div className="col-span-2">
            <FeaturedArticle title="Développeur et Entrepreneur, Le Duo Gagnant dans le Monde des Affaires" img={Article1} summary="Dans le monde dynamique des affaires d'aujourd'hui, la synergie entre le rôle de développeur et celui d'entrepreneur est devenue un atout majeur. Cet article explore de manière approfondie comment la fusion de ces deux compétences distinctes, le développement informatique et l'entrepreneuriat..." time="9 min read, à suivre bientôt" />
          </div> 

          <div className=" col-span-2">
            <FeaturedArticle title="Laravel : Optimiser le Code pour Aller au-delà du Simple Fonctionnement" img={Article2} summary="Laravel, avec sa syntaxe élégante et ses fonctionnalités puissantes, est devenu un choix privilégié pour de nombreux développeurs. Cependant, l'optimisation du code va bien au-delà de la simple exécution des fonctionnalités de base. Cet article plonge dans l'art de maximiser les performances..." time="9 min read, à suivre bientôt" />
          </div>  
        </ul>
        ...
        <ul className="w-full dark:text-light">
          <Article img={Article1} title="Manssah : Un rêve d'enfance sur lequel les aînés travaillent déjà?" date="12 Février 2024"  />
          <Article img={Article1} title="Lean Startup et Build In Public : Les Outils de l'Odyssée Entrepreneuriale." date="12 Mars 2024" link="" />
          <Article img={Article1} title="ReactJS : Construire des Interfaces Utilisateur Dynamiques et Réactives" date="12 Mai 2024" link="" />
          
          <Article img={Article1} title="Équilibre Spirituel : Naviguer entre Humilité et Confiance en Soi." date="12 Avril 2024" link="" />

          <Article img={Article1} title="Maîtriser le Développement Web avec TDD : Guide Complet." date="12 Juin 2024" link="" />
        </ul>
